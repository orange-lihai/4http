...
@Getter
@ATable(name = "tb_div")
public class TBDiv implements ITable {
  public static final String DOM_ID_PREFIX = "div_";
  private String id; // PK
  @ATableColumn(name = "pid") private String parentId;
  private TBDiv parent;
  @ATableColumn(name = "sid") private String siblingId;
  private TBDiv sibling;
  private String name;
  @ATableColumn(name = "show_name") private String showName;
  @ATableColumn(name = "data_selector") private String dataSelector;
  @ATableColumn(name = "html_code") private String htmlCode;
  @ATableColumn(name = "css_code") private String cssCode;
  @ATableColumn(name = "attrs") private String attrs;
  @ATableColumn(name = "system_id") private String systemId;
  @ATableColumn(name = "div_type") private String divType;

  private Map<String, Object> dataContext;
  private String dataId; // examples: name.key1.key2, name[1].key3, ...
  private List<TBDiv> children;
  ...
  // ----------------------------------------------------------------------------------------- //
  public TBDiv() {}
  public TBDiv(String id) {this.id = id; }
  // ----------------------------------------------------------------------------------------- //
  public void appendChildren(TBDiv... divs) {
    if (null == children) { children = new ArrayList<>(); }
    children.addAll(Arrays.asList(divs));
  }

  public void appendChildren(List<TBDiv> divs) {
    if (null == children) { children = new ArrayList<>(); }
    children.addAll(divs);
  }
